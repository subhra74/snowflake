...
public class KeyManagerPanel extends JPanel implements AutoCloseable {
	...
	public KeyManagerPanel(SessionInfo info, RemoteSessionInstance instance) {
//		setLayout(cardLayout);
//		this.info = info;
//		holder = new SshKeyHolder();
//
//		tabs = new TabbedPanel();
//		remoteKeyPanel = new RemoteKeyPanel(info, a -> {
//			cardLayout.show(this, "Wait");
//			executorService.submit(() -> {
//				try (SshFileSystem fileSystem = instance.getSshFs()) {
...
//			});
//		});
//		localKeyPanel = new LocalKeyPanel(info, a -> {
//			cardLayout.show(this, "Wait");
//			executorService.submit(() -> {
//				try (SshFileSystem fileSystem = instance.getSshFs()) {
//					this.fileSystem = fileSystem;
...
//				"Create, edit or manage SSH keys for remote and local machine",
//				"Open", e -> {
//					cardLayout.show(this, "Wait");
//					executorService.submit(() -> {
//						try (SshFileSystem fileSystem = instance.getSshFs()) {
