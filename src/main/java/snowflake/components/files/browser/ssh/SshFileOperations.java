...
public class SshFileOperations {
	...
	public boolean runScriptInBackground(RemoteSessionInstance instance,
			String command, AtomicBoolean stopFlag) {
	...
	public boolean createLink(FileInfo[] files, FileSystem fs,
			RemoteSessionInstance instance) {
		JTextField txtLinkName = GraphicsUtils.createTextField(30);// new
																	// JTextField(30);
		JTextField txtFileName = GraphicsUtils.createTextField(30);// new
																	// JTextField(30);
		...
		if (JOptionPane.showOptionDialog(null,
				new Object[] { "Create link", txtLinkName, "File name",
