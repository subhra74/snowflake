...
public class SshFileBrowserView extends AbstractFileBrowserView {
	...
	public SshFileBrowserView(FileBrowser fileBrowser, JRootPane rootPane,
			FileComponentHolder holder, String initialPath,
			PanelOrientation orientation) {
		super(rootPane, holder, orientation, fileBrowser,
				new Color(250, 250, 250));// new Color(240, 255, 240));
		...
		this.transferHandler = new DndTransferHandler(this.folderView,
				holder.getInfo(), this, DndTransferData.DndSourceType.SSH);
				...
				try {
					...
					if (JOptionPane.showConfirmDialog(null,
							"Unable to connect to server "
									+ holder.getInfo().getName() + " at "
									+ holder.getInfo().getHost()
