...
public class RoundedButtonPainter {
	...
	public RoundedButtonPainter() {
		this.normalGradient = new GradientPaint(0, 0,
				GraphicsUtils.getThemeColor("button.normalGradient1"), 0, 50,
				GraphicsUtils.getThemeColor("button.normalGradient2"));
		this.hotGradient = new GradientPaint(0, 0,
				GraphicsUtils.getThemeColor("button.hotGradient1"), 0, 50,
				GraphicsUtils.getThemeColor("button.hotGradient2"));
		this.pressedGradient = new GradientPaint(0, 0,
				GraphicsUtils.getThemeColor("button.pressedGradient1"), 0, 50,
				GraphicsUtils.getThemeColor("button.pressedGradient2"));
		this.borderColor = GraphicsUtils.getThemeColor("nimbusBorder");
