...
import muon.screens.sessiontabs.MainContainer;
...
//        System.setProperty("sun.java2d.uiScale", "2.0");
        ...
        var f = isWindows ? new CustomFrame("Muon") : new JFrame("Muon");
...
//            var sessionInfo = SessionManager.showDialog(f);
//            if (sessionInfo != null) {
