...
public class LogViewer extends Page {
	...
	public LogViewer(SessionContentPanel sessionContent) {
		...
		ClosableTabbedPanel.TabTitle tabTitle = new ClosableTabbedPanel.TabTitle();
	...
	public String getText() {
		return App.bundle.getString("server_logs");
	}
	...
	public void openLog(String remotePath) {
		...
		ClosableTabbedPanel.TabTitle title = new ClosableTabbedPanel.TabTitle();
