...
public class SystemLoadPanel extends JPanel {
	...
	public SystemLoadPanel() {
		...
		cpuLabel = new JLabel(App.bundle.getString("cpu_usage"));
		...
		memoryLabel = new JLabel(App.bundle.getString("memory_usage"));
		...
		swapLabel = new JLabel(App.bundle.getString("swap_usage"));
...
//        add(new JLabel("System performance"), BorderLayout.NORTH);
	...
	public void refreshUi() {
		this.cpuLabel
				.setText(String.format(App.bundle.getString("cpu_usage") +": %.1f", cpuUsage) + "% ");
		this.memoryLabel.setText(String.format(App.bundle.getString("memory_usage") +": %.1f",
				memoryUsage)
				+ "%"
				+ (totalMemory != 0
						? (", (Total: " + FormatUtils
								.humanReadableByteCount(totalMemory, true)
								+ ", "+ App.bundle.getString("used2") +": "
								+ FormatUtils.humanReadableByteCount(usedMemory,
										true)
								+ ")")
						: ""));
		this.swapLabel.setText(String.format(App.bundle.getString("swap_usage") +": %.1f", swapUsage)
				+ "% "
				+ (totalSwap != 0
						? (", ( Total: "
								+ FormatUtils.humanReadableByteCount(totalSwap,
										true)
								+ ", "+ App.bundle.getString("used2") +": " + FormatUtils
