...
public class DiskspaceAnalyzer extends Page {
	...
	private Component createResultPanel() {
		...
		JButton btnStart = new JButton(App.bundle.getString("start_another_analysis"));
		...
		JLabel resultTitle = new JLabel(App.bundle.getString("directory_usage"));
	...
	private Component createFirstPanel() {
		JRadioButton radFolder = new JRadioButton(App.bundle.getString("analize_folder"));
		JRadioButton radVolume = new JRadioButton(App.bundle.getString("analize_volume"));
		...
		JButton btnNext = new JButton(App.bundle.getString("next"));
	...
	private Component createVolumesPanel() {
		...
		JButton btnBack = new JButton(App.bundle.getString("back"));
		JButton btnNext = new JButton(App.bundle.getString("next"));
		JButton btnReload = new JButton(App.bundle.getString("reload"));
		...
		btnNext.addActionListener(e -> {
			...
			if (x != -1) {
				...
				JOptionPane.showMessageDialog(this, App.bundle.getString("select_partition"));
				return;
			}
		});
		...
		JLabel lblTitle = new JLabel(App.bundle.getString("select_volume"));
	...
	public String getText() {
		return App.bundle.getString("diskspace");
	}
