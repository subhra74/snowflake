...
public class RemoteKeyPanel extends JPanel {
	...
	public RemoteKeyPanel(SessionInfo info, Consumer<?> callback1,
		...
		btnRefresh = new JButton(App.bundle.getString("generate"));
		...
		btnAdd = new JButton(App.bundle.getString("add"));
		btnEdit = new JButton(App.bundle.getString("edit"));
		btnRemove = new JButton();

		btnAdd.addActionListener(e -> {
			String text = JOptionPane.showInputDialog(null, App.bundle.getString("new_entry"));
		...
		btnEdit.addActionListener(e -> {
			...
			if (index < 0) {
				JOptionPane.showMessageDialog(null, App.bundle.getString("no_entry_selected"));
				return;
			}
			String str = model.get(index);
			String text = JOptionPane.showInputDialog(null, App.bundle.getString("new_entry"), str);
			if (text != null && text.length() > 0) {
		...
		hbox2.add(new JLabel(App.bundle.getString("authorized_keys")));
