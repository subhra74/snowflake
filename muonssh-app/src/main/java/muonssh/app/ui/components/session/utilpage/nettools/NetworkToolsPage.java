 ...
 * 
 */
package muonssh.app.ui.components.session.utilpage.nettools;
	...
	protected void createUI() {
		...
		btn1.addActionListener(e -> {
			if (JOptionPane.showOptionDialog(this,
					new Object[] { App.bundle.getString("host_ping"), cmbHost }, "Ping",
		...
		btn2.addActionListener(e -> {
			if (JOptionPane.showOptionDialog(this,
					new Object[] { App.bundle.getString("host_name"), cmbHost, App.bundle.getString("port_number"),
							cmbPort },
		...
		btn3.addActionListener(e -> {
			if (JOptionPane.showOptionDialog(this,
					new Object[] { App.bundle.getString("host_name"), cmbHost }, "Traceroute",
					JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
					null, null, null) == JOptionPane.OK_OPTION) {
		...
		btn4.addActionListener(e -> {
			if (JOptionPane.showOptionDialog(this,
					new Object[] { App.bundle.getString("host_name"), cmbHost, App.bundle.getString("tool_use"),
							cmbDNSTool },
			...
			try {
				...
				if (holder.getRemoteSessionInstance().execBin(cmd, stopFlag,
					...
					JOptionPane.showMessageDialog(this,
							App.bundle.getString("executed_errors"));
				}
			} catch (Exception e) {
				e.printStackTrace();
			} finally {
